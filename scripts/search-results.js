...
function generateRelevantResults(query) {
    ...
    const knowledgeBase = [
        ...
        { keywords: ['产品手册', '手册', '产品', '说明书', '指南'], type: 'document', category: '产品手册',
          titles: ['智算一体机产品手册', '移动云产品使用指南', '云电脑设备安装手册', '产品功能说明书', '技术规格手册'] },

        // 故障排查相关
        { keywords: ['故障排查', '故障', '排查', '问题', '错误', '异常', '修复'], type: 'qa', category: '故障排查',
          titles: ['网络连接故障排查指南', '云桌面异常处理方案', '设备故障诊断手册', '常见问题解决方案', '系统错误排查流程'] },

        // 客户案例相关
        { keywords: ['客户案例', '案例', '客户', '成功案例', '应用案例', '实施案例'], type: 'solution', category: '客户案例',
          titles: ['某大型企业智算一体机部署案例', '工业互联网应用成功案例', '智慧工厂云电脑改造案例', '医院云桌面建设案例', '教育行业云电脑升级案例'] },

        // 智算一体机相关
        { keywords: ['智算一体机', '智算', '一体机', '云电脑', '云桌面'], type: 'document', category: '技术文档',
          titles: ['智算一体机技术深度解析', '云电脑安全防护最佳实践', '云桌面虚拟化技术应用', '智算一体机部署实施指南', '云电脑性能优化'] },

        // 培训资料相关
        { keywords: ['培训', '培训资料', '学习', '教程', '课程'], type: 'video', category: '培训资料',
          titles: ['智算一体机技术培训课程', '云电脑运维培训教程', '产品操作培训视频', '技术认证培训资料', '专业技能培训指南'] },
